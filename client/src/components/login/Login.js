...
const Login = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url("https://www.euroschoolindia.com/wp-content/uploads/2023/08/good-colleges.jpg")`,
        ...
        <div className="grid grid-cols-2 gap-28">
          <div className="h-96 w-96 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[#5a51d6] bg-opacity-60 rounded-xl">
            ...
            <Link
              ...
              className="flex items-center justify-center bg-orange-500 h-10 w-32 text-lg rounded-lg text-white hover:scale-110 transition-all duration-200">
              Login
            </Link>
          </div>
